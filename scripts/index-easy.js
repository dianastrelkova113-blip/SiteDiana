    ...
    Sections: [
        {
            ...
            tests: [
                {
                    question: 'Расставь шаги разбора по порядку:\n1.Записать транскрипцию\n2.Записать слово\n3.Поставить ударение\.4.Охарактеризовать звуки\n5.Подсчитать буквы и звуки\n6.Разделить на слоги\nПример: 1,2,3,4,5,6',
                    answer: '4,1,2,5,6,3',
                    hint: 'Посчитай гласные звуки — сколько гласных, столько и слогов.'
                },
                {
                    question: 'Какой шаг пропущен?\nСлово → ударение → слоги → … → подсчёт букв и звуков',
                    answer: 'транскрипция',
                    hint: 'Сколько в слове гласных? Столько же и слогов.'
                },
                {
                    question: '',
                    options: ['Разделить на слоги', 'Охарактеризовать звуки', 'Поставить ударение'],
                    answer: 1,
                    hint: ''
                }
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'В каком слове гласный [а] ударный?',
                    options: ['мама', 'молоко', 'письмо'],
                    answer: 0,
                    hint: ''
                },
                {
                    question: 'Выбери слово, где гласный [о] безударный:',
                    options: ['дом', 'окна', 'вода'],
                    answer: 2,
                    hint: 'Буква "е" в начале слова даёт два звука'
                },
                {
                    question: 'Найди слово с ударным и:',
                    options: ['мир', 'зима', 'пила'],
                    answer: 0,
        ...
        },
        {
            ...
            tests: [
                {
                    question: 'В каком слове все согласные звуки твердые?',
                    options: ['лес', 'дом', 'мяч'],
                    answer: 1,
                    hint: 'Глухие согласные не имеют звучания'
                },
                {
                    question: 'Найди слово, которое начинается с мягкого согласного звука:',
                    options: ['мак', 'мир', 'сок'],
                    answer: 1,
                    hint: `Буква "ь" не даёт звука, но после неё "ю" = [й'у]`
                },
                {
                    question: 'Выбери слово, где звук [з] звонкий:',
                    options: ['лес', 'зуб', 'суп'],
                    answer: 1,
                    hint: 'Парные глухие согласные — это [п], [т], [к]'
                }
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'Какой транскрипцией записано слово лес?',
                    options: ['[л’эс]', `[лэс]`, '[л’эс’]'],
                    answer: 0,
                    hint: 'Транскрипция показывает правильное произношение слова'
                },
                {
                    question: 'Выбери верную транскрипцию слова мяч:',
                    options: ['[м’ач]', '[м’ач’]', '[мач]'],
                    answer: 1,
                    hint: 'Транскрипция показывает правильное произношение слова'
                },
                {
                    question: 'Выбери верную транскрипцию слова ёж:',
                    options: ['[й’ош]', '[йож]', '[йош’]'],
                    answer: 0,
                    hint: 'Транскрипция показывает правильное произношение слова'
                }
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'В каком слове буква е дает два звука?',
                    options: ['лес', 'ель', 'печь'],
                    answer: 1,
                    hint: 'Буква "е" в начале слова даёт два звука'
                },
                {
                    question: 'Найди слово с буквой я, которая дает два звука:',
                    options: ['мяч', 'яма', 'ряд'],
                    answer: 1,
                    hint: 'Буква "я" в начале слова даёт два звука'
                },
                {
                    question: 'В каком слове буква ю обозначает два звука?',
                    options: ['люк', 'клюв', 'юг'],
                    answer: 2,
                    hint: 'Буква "ю" в начале слова даёт два звука'
                }
            ]
        },
        {
            ...
            tests: [
                {
                    ...
                    options: ['дом', 'яма', 'стол'],
                    answer: 1,
                    hint: 'Буква "е" в начале слова даёт два звука'
                },
                {
                    question: 'Выбери слово, в котором букв больше, чем звуков:',
                    options: ['лень', 'лес', 'дом'],
                    answer: 0,
                    hint: 'Буква "я" в начале слова даёт два звука'
                },
                {
...
const initTest = (section) =>{
    ...
    for (let i = 0; i < section.tests.length; i++) {
        ...
        buttonTheory.textContent = "Показать теорию";
        buttonTheory.onclick = () => {
            initPopupTheory(THEORY[selectedPopupSection]);
        ...
        buttonTheory.classList.add("theory-button");
        buttonsLayout.appendChild(buttonTheory);
    ...
    if(selectedSection == TEST.Sections.length - 1){
        ...
        buttonNext.onclick = nextSection;
    }
}
