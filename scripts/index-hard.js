            ...
            body: [
                {
                    ...
                    body: "В русском языке есть несколько случаев, когда колличество звуков и букв не совпадает."
                },
                {
            ...
            tests: [
                {
                    ...
                    answer: '7, 6, непроизносимая согласная д'
                },
                {
...
THEORY = [
    {
        ...
        body: [
            ...
            },
            {
                definition:{
                    term: "Фонетика",
                    description: "нраздел науки о языке, изучающий звуки речи."
                }
            },
            {
                definition:{
    ...
    },
    {
        ...
        body: [
            {
                paragraph: "Мы уже занаем как делаеть звуко-буквенный разбо слова. Сегодня мы углубимся в эту тему и изучим гласные и согласные звуки."
            },
            {
                definition:{
                    term: "Звук",
            ...
            if(test.userAnswer == test.answer){
                ...
                if(test.answer instanceof Array && test.userAnswer instanceof Array){
                    ...
                    if(sortedUserAnswer == sortedAnswer){
                        ...
                        test.hintElement.innerHTML = `Ответ не правильный.`;
                        test.hintElement.classList.add("wrong");
                        allCorrect = false;
                    }
                }
