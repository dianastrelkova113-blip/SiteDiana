    ...
    Sections: [
        {
            ...
            tests: [
                {
                    question: 'Выполни разбор слова "съесть". Запиши ответы через запятую. Не забудь написать транскрипцию в [] (квадратных скобках).\nБукв: __\nЗвуков: __\nТранскрипция: [________]',
                    answer: '6, 5, [сй’эст’]',
                    rightAnswer: '6, 5, [сй’эст’]'
                },
                {
                    question: 'Выполни разбор слова "объявление". Запиши ответы через запятую. Не забудь написать транскрипцию в [] (квадратных скобках).\nБукв: __\nЗвуков: __\nТранскрипция: [________]',
                    answer: '10, 11, [абй’ивл’эн’ий’э]',
                    rightAnswer: '10, 11, [абй’ивл’эн’ий’э]'
                },
                {
                    question: 'Сравни разбор слов съесть и объявление. В каком из них звуков больше, чем букв, и почему?',
                    options: ['съесть, потому что ь не дает звука', 'объявление, потому что я дает два звука после гласной', 'в обоих поровну'],
                    answer: 1,
                    rightAnswer: 'объявление, потому что я дает два звука после гласной'
                },
            ]
        },
        {
            ...
            tests: [
                {
                    ...
                    options: ['алфавит', 'документ', 'звонят'],
                    answer: [0,1,2],
                    rightAnswer: 'алфавит, документ, звонят'
                },
                {
                    question: 'Выпиши через запятую все буквы безударного гласного звука в предложении «На горе рос высокий дуб»: ',
                    answer: 'а, о, ы, и',
                    rightAnswer: 'а, о, ы, и'
                },
                {
                    question: 'В каком слове все гласные в корне безударные?',
                    options: ['голова', 'город', 'берег'],
                    answer: [0],
                    rightAnswer: 'голова'
                },
                {
                    question: 'В каком слове ударение падает на второй слог?',
                    options: ['документ', 'каталог', 'щавель'],
                    answer: [2],
                    rightAnswer: 'щавель'
                },
                {
                    question: 'В каком ряду во всех словах ударение падает на первый слог?',
                    options: ['свёкла, торты, банты', 'жалюзи, звонит, красивее', 'каталог, договор, квартал'],
                    answer: 0,
                    rightAnswer: 'свёкла, торты, банты'
                },
        ...
        },
        {
            ...
            tests: [
                {
                    question: 'Найди в предложении «Съел бы щей, да нет капусты» все глухие согласные звуки (перечисли по одному разу):',
                    answer: `[с], [щ'], [т], [к], [п]`,
                    rightAnswer: `[с], [щ'], [т], [к], [п]`
                },
                {
                    question: 'Выбери пару слов-омофонов:',
                    options: ['луг — лук', 'лес — лис', 'дом — дым'],
                    answer: 0,
                    rightAnswer: 'луг — лук'
                },
                {
                    question: 'В каком слове буква с произносится как [з]?',
                    options: ['сделать', 'сбежать', 'сдать'],
                    answer: [0,1,2],
                    rightAnswer: 'сделать, сбежать, сдать'
                },
                {
                    question: 'В каком слове согласный звук становится мягким под влиянием следующего мягкого согласного?',
                    options: ['мост', 'кость', 'бант'],
                    answer: 1,
                    rightAnswer: 'кость'
                },
                {
                    question: 'В каком слове все согласные звуки глухие?',
                    options: ['суп', 'кот', 'шум', 'пух'],
                    answer: [0,1,3],
                    rightAnswer: 'суп, кот, пух'
                },
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'Запиши транскрипцию предложения «Мой брат съел торт»:',
                    answer: `[мой' брат сй'эл торт]`,
                    rightAnswer: `[мой’ брат сй’эл торт]`
                },
                {
                    question: 'Запиши транскрипцию слова подъезд:',
                    answer: `[падй'эст]`,
                    rightAnswer: `[падй’эзд]`
                },
                {
                    question: 'Запиши транскрипцию слова поздно:',
                    answer: `[позна]`,
                    rightAnswer: `[позна]`
                },
                {
                    question: 'Выбери верную транскрипцию слова счастье:',
                    options: ["[щ'ас'т'й'э]", "[с'ч'ас'т'йэ]", "[щ'ас'т'э]"],
                    answer: 0,
                    rightAnswer: '[щ’ас’т’й’э]'
                },
                {
                    question: 'Запиши транскрипцию фразы «Его зовут Иван»:',
                    answer: `[й'иво завут иван]`,
                    rightAnswer: `[й’иво завут иван]`
                },
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'В каком слове буква е в начале слова дает два звука?',
                    options: ['поехал', 'ехал', 'белый'],
                    answer: 1,
                    rightAnswer: 'ехал'
                },
                {
                    question: 'В каком слове буква я стоит после разделительного ъ?',
                    options: ['объявление', 'маяк', 'яма'],
                    answer: 0,
                    rightAnswer: 'объявление'
                },
                {
                    question: 'Выбери слово, в котором "ё" дает два звука:',
                    options: ['ёлка', 'мёд', 'тётя'],
                    answer: 0,
                    rightAnswer: 'ёлка'
                },
                {
                    question: 'В каком слове буква "ю" стоит после разделительного "ъ" и дает два звука?',
                    options: ['вьюга', 'люк', 'съюлить'],
                    answer: 2,
                    rightAnswer: 'съюлить'
                },
                {
                    question: 'В каком слове буква я обозначает один звук и смягчает предыдущий согласный?',
                    options: ['маяк', 'мясо', 'яма'],
                    answer: 1,
                    rightAnswer: 'мясо'
                },
            ]
        },
        {
            ...
            tests: [
                {
                    question: 'Выполни разбор слова "поздний". Ответы напиши через запятую.\nБукв: __\nЗвуков: __\nПричина: ________',
                    answer: ['7,6,непроизносимаясогласнаяд', '7,6,букваднеобозначаетзвук', '7,6,букваднепроизносится', '7,6,непроизносимаяд'],
                    rightAnswer: '7, 6, непроизносимая согласная д'
                },
                {
                    question: 'В каком слове происходит оглушение звонкого согласного в середине слова?',
                    options: ['лавка', 'дуб', 'просьба'],
                    answer: 0,
                    rightAnswer: 'лавка'
                },
                {
                    question: 'Выполни разбор слова "грустный":\nБукв: __\nЗвуков: __\nПричина: ________',
                    answer: ['8,7,непроизносимая согласнаят', '8,7,букватнеобозначаетзвук', '8,7,букватнепроизносится', '8,7,непроизносимаят'],
                    rightAnswer: '8, 7, непроизносимая согласная т'
                },
                {
                    question: 'Найди слова, в котором букв больше, чем звуков:',
                    options: ['яблоко', 'солнце', 'пень', 'ёлка'],
                    answer: [1,2],
                    rightAnswer: 'солнце, пень'
                },
                {
                    question: 'Выполни разбор слова "съёмка":\nБукв: __\nЗвуков: __\nТранскрипция: [________]',
                    answer: "6, 6, [сй'омка]",
                    rightAnswer: '6, 6, [сй’омка]'
                },
            ]
        }
    ]
